    ...
    plugins: [
        federation({
            ...
            exposes: {
                ...
                './SpectrumHomematic': './src/SpectrumHomematic',
                './Farbtastic': './src/Farbtastic',
                './RgbColor': './src/RgbColor',
                './HueColor': './src/HueColor',
                './HuePickerXY': './src/HuePickerXY',
                './HueIndicatorXY': './src/HueIndicatorXY',
                './HuePickerCT': './src/HuePickerCT',
                './HueIndicatorCT': './src/HueIndicatorCT',
