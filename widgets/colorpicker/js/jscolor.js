    ...
    window.jscolor = (function () {
        var jsc = {
                ...
                switch (jsc.getPadYComponent(thisObj)) {
                    ...
                    case 'i':
                        if (thisObj.gamutZoom) {
                            var xy = huepi.HelperZoomXYforModel(
                                x / (thisObj.width - 1),
                                1 - y / thisObj.height,
                                thisObj.gamut,
                            );
                        ...
                        for (var x = 0; x < canvas.width; x++) {
                            ...
                            for (var y = 0; y < canvas.height; y++) {
                                ...
                                if (gamutZoom) {
                                    ...
                                    xy = [x / canvas.width, 1 - y / canvas.height];
                                }
                                var XYColor = huepi.HelperXYtoRGBforModel(xy[0], xy[1], 1, gamut);
                                var TestColor = huepi.HelperXYtoRGB(xy[0], xy[1], 1);
                                if (
                                    TestColor.Red != XYColor.Red ||
                                    TestColor.Green != XYColor.Green ||
                                    TestColor.Blue != XYColor.Blue
                                ) {
            ...
            jscolor: function (targetElement, options) {
                ...
                this.fromXY = function (x, y, b, flags) {
                    // null = don't change
                    ...
                    this.fromRGB(
                        Math.round(cieColor.Red * 255),
                        Math.round(cieColor.Green * 255),
                        Math.round(cieColor.Blue * 255),
                        jsc.leaveSld,
                    );
                    this.exportColor(flags);
                };
